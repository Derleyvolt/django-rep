...
from .views import ProjetoView, UserAccountView, RubricaView, TagView, TipoMovimentacaoView, ExtratoView, FavorecidoView, ExecutorView
...
router.register('', ExecutorView,           basename='executorview')
